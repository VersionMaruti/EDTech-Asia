        ...
        <React.Fragment>
            ...
            <div className=' '>
                ...
                <div className='relative h-[450px] md:h-[550px] justify-center mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white '>
                    ...
                    <Link to={"/signup"}>
                        <div className='z-0 group p-1 mx-auto rounded-full bg-white font-bold text-richblack-200
                                        transition-all duration-200 hover:scale-95 w-fit'>
                            <div className='flex flex-row items-center gap-2 rounded-full px-10 py-[5px] bg-[#2847b0]
                              transition-all duration-200 group-hover:bg-richblack-900 text-lg'>
                    ...
                    >
                        Access our online coding courses at your convenience, no matter where you are, and benefit from a diverse range of resources, including interactive projects, quizzes, and personalized guidance from our skilled instructors.
                    </motion.div>
